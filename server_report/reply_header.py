...
def return_mime_type(config, file_path=None):
        ...
        if file_path is None:
            ...
            last_modified = datetime.utcfromtimestamp(statinfo.utctime)
            response["last_modified"] = last_modified.utctime("%a, %d %b %Y %H:%M:%S GMT")
